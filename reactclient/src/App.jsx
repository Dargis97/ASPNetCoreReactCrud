    ...
    <div className="container">
      <div className="row min-vh-100">
        <div className="col d-flex flex-column justify-content-center align-items-center">
          {newPostForm === false && postUpdated === null && (
            <div>
          ...
          {newPostForm && <PostCreateForm onPostCreated={onPostCreated} />}

          {postUpdated !== null && (
            <PostUpdateForm post={postUpdated} onPostUpdated={onPostUpdated} />
          )}
        </div>
      </div>
    </div>
